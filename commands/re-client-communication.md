---
description: "On-brand email, text, call scripts, and status updates for any transaction stage"
...
Read the SKILL.md file at:
  ~/Skills/real-estate-plugin/skills/re-client-communication/SKILL.md
